            ...
            <div>
              <div className="relative">
                <input
                  ...
                  className={`w-full px-6 py-4 pr-14 bg-slate-50 border ${error ? 'border-red-500' : 'border-slate-200'
                    } rounded-2xl focus:outline-none focus:ring-4 focus:ring-red-500/10 focus:border-red-500 transition-all font-bold text-center placeholder:text-slate-400 text-slate-900 tracking-widest`}
                  autoFocus
                />
              ...
              {error && (
                <p className="text-[10px] font-black text-red-600 uppercase mt-3 animate-bounce text-center">
                  {error}
                </p>
              )}
            </div>
